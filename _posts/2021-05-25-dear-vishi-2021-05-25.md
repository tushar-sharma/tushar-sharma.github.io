...
<div id="form1">
  <form name='test'>
    <span style="bold 15px  Arial, sans-serif;"><input onclick="changeImage(this)" type="checkbox" image="https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Th%C3%ADch_Qu%E1%BA%A3ng_%C4%90%E1%BB%A9c_self-immolation.jpg/1920px-Th%C3%ADch_Qu%E1%BA%A3ng_%C4%90%E1%BB%A9c_self-immolation.jpg" name="field" value="one">I understand follwoing image can be distressing</span>
  </form>
</div> <br>
