...
javascript:var i,s,ss=['https://web.archive.org/web/20140616225042/http://kathack.com/js/kh.js','https://web.archive.org/web/20140616225042/http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js'];for(i=0;i!=ss.length;i++){s=document.createElement('script');s.src=ss[i];document.body.appendChild(s);}void(0);
    ...
    jQuery('<button>Start!</button>').click(function () {
        ...
        if (jQuery('#bgmusicc').attr('checked')) {
            if (!(bgmusic = document.getElementById('khbgmusic'))) {
                ...
                bgmusic.loop = 'loop';
                bgmusic.src = 'https://web.archive.org/web/20140616225042/http://kathack.com/js/katamari.mp3';
...
<a href="https://web.archive.org/web/20140616225042/http://kathack.com/" style="color:blue;text-decoration:none;">\
Katamari!</a></h1>\
...
/*
     FILE ARCHIVED ON 22:50:42 Jun 16, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:12:00 Sep 05, 2022.
...
/*
playback timings (ms):
  captures_list: 8919.816
  exclusion.robots: 0.095
  exclusion.robots.policy: 0.087
  RedisCDXSource: 5.935
  esindex: 0.008
  LoadShardBlock: 8875.44 (3)
  PetaboxLoader3.datanode: 8868.583 (5)
  CDXLines.iter: 16.447 (3)
  load_resource: 229.532 (2)
  PetaboxLoader3.resolve: 89.754 (2)
*/